...
//  ProsperPlayerDemo
//
//  Crossfade with pause demo - pause during crossfade
//  Critical test: pause/resume during transition between tracks
//
...
struct CrossfadeWithPauseView: View {
    ...
    @State private var crossfadeDuration: Double = 8.0
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Crossfade + Pause")
    ...
    private var headerSection: some View {
        VStack(spacing: 8) {
            ...
            Text("Pause during crossfade transition")
                .font(.subheadline)
    ...
    private var infoSection: some View {
        VStack(alignment: .leading, spacing: 8) {
            Label("Test Scenario", systemImage: "info.circle.fill")
                .font(.headline)
                .foregroundStyle(.blue)

            Text("This demo tests the critical pause-during-crossfade functionality:")
                .font(.caption)
                .foregroundStyle(.secondary)

            VStack(alignment: .leading, spacing: 4) {
                Text("1. Play playlist with long crossfade (8s)")
                Text("2. Wait for crossfade to start")
                Text("3. Pause during crossfade")
                Text("4. Resume - should continue smoothly")
            }
            .font(.caption)
            .foregroundStyle(.secondary)

            Text("Note: Use long crossfade duration to have time to pause during transition!")
                .font(.caption2)
                .foregroundStyle(.orange)
                .padding(.top, 4)
        }
