...
struct QueueDiagnosticsDemoView: View {
    ...
    private var infoSection: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            Text("✅ Diagnostics enabled (DEBUG + ENABLE_QUEUE_DIAGNOSTICS)")
                .font(.caption)
            ...
            Text("Compile flag ENABLE_QUEUE_DIAGNOSTICS added to Package.swift")
                .font(.caption2)
                .foregroundStyle(.secondary)
            #endif
        }
    ...
    private func fetchDiagnostics() async {
        ...
        💡 To enable:
        1. ✅ ENABLE_QUEUE_DIAGNOSTICS flag added to Package.swift
        ...
        2. ENABLE_QUEUE_DIAGNOSTICS compile flag

        Current status:
        - DEBUG: \(isDebugBuild ? "✅" : "❌")
        - ENABLE_QUEUE_DIAGNOSTICS: ❌ (not compiled)
